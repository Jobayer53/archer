...
<head>
    ...
    <!-- Title -->
    <title> Nirjon - Personal Portfolio</title>
...
<body class="dark" data-spy="scroll" data-target="#scrollspy" data-offset="1">
    ...
    <div class="header-left" id="scrollspy">
        ...
        <div class="logo bg-base-color">
            <a href="index.html" class="text-white mb-0">M</a>
        </div>
            ...
            <div class="cross bg-base-color">
             ...
             <nav class="menu">
                 <ul class="menu-nav">
                     ...
                     <li class="nav-item">
                         <a class="nav-link " href="{{ route('index')}}">Works</a>
                     </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="blog-single-inner">
                            ...
                            <div class="content">
                                <small class="text-muted">09 March, 2020 <span class="dot"></span>  #Design , #web <span class="dot"></span> 15 Min Reads</small>
                                <h3 class="title  mb-15 mt-10"> What's the different between Graphic and web design</h3>
                                <p>Its sometimes her behaviour are contented. Do listening am eagerness oh objection collected. Together gay feelings continue
                                    juvenile had off Unknown may service subject her letters one bed. Child years noise ye in forty. Loud in this in both
                                ...
                                <h5> 1- What is Graphic Design?</h5>
                                ...
                                <h5> 3 - Why This Difference is Important </h5>
